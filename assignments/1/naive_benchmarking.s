...
# naive_benchmarking.c:11:   const long int iterations = 1E9;
	movq	$1000000000, -16(%rbp)	#, iterations
# naive_benchmarking.c:14:   for (long int ix = 0; ix < iterations; ++ix) {
	movq	$0, -32(%rbp)	#, ix
# naive_benchmarking.c:14:   for (long int ix = 0; ix < iterations; ++ix) {
	jmp	.L2	#
.L3:
# naive_benchmarking.c:15:     sum += ix;
	movq	-32(%rbp), %rax	# ix, tmp88
	addq	%rax, -40(%rbp)	# tmp88, sum
# naive_benchmarking.c:14:   for (long int ix = 0; ix < iterations; ++ix) {
	addq	$1, -32(%rbp)	#, ix
.L2:
# naive_benchmarking.c:14:   for (long int ix = 0; ix < iterations; ++ix) {
	movq	-32(%rbp), %rax	# ix, tmp89
	cmpq	-16(%rbp), %rax	# iterations, tmp89
	jl	.L3	#,
# naive_benchmarking.c:17:   end = clock();
	call	clock@PLT	#
	movq	%rax, -8(%rbp)	# tmp90, end
# naive_benchmarking.c:18:   seconds = (float)(end - start) / CLOCKS_PER_SEC;
	movq	-8(%rbp), %rax	# end, tmp91
	subq	-24(%rbp), %rax	# start, _1
# naive_benchmarking.c:18:   seconds = (float)(end - start) / CLOCKS_PER_SEC;
	pxor	%xmm0, %xmm0	# _2
	cvtsi2ssq	%rax, %xmm0	# _1, _2
# naive_benchmarking.c:18:   seconds = (float)(end - start) / CLOCKS_PER_SEC;
	movss	.LC0(%rip), %xmm1	#, tmp93
	divss	%xmm1, %xmm0	# tmp93, tmp92
	movss	%xmm0, -44(%rbp)	# tmp92, seconds
# naive_benchmarking.c:19:   printf("The sum is %ld.\n", sum);
	movq	-40(%rbp), %rax	# sum, tmp94
	movq	%rax, %rsi	# tmp94,
...
# naive_benchmarking.c:20:   printf("The program took %f seconds to run.\n", seconds);
	pxor	%xmm2, %xmm2	# _3
	cvtss2sd	-44(%rbp), %xmm2	# seconds, _3
	movq	%xmm2, %rax	# _3, _3
	movq	%rax, %xmm0	# _3,
